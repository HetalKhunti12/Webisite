...
class CommunicationsControllerTest < ActionController::TestCase
  ...
  test "should create communication" do
    assert_difference('Communication.count') do
      post :create, communication: { body: @communication.body, contact_id: @communication.contact_id, reciever_id: @communication.reciever_id, sender_id: @communication.sender_id, subject: @communication.subject }
    end
  ...
  test "should update communication" do
    patch :update, id: @communication, communication: { body: @communication.body, contact_id: @communication.contact_id, reciever_id: @communication.reciever_id, sender_id: @communication.sender_id, subject: @communication.subject }
    assert_redirected_to communication_path(assigns(:communication))
  end
